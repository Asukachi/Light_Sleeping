...
data: {
          buttons3:[
				{type:'button',url:App.renderUrl('inside_sleep_music','index'),title:``}
			],
     buttons5:[
				{type:'button',url:App.renderUrl('custom_sleepmusic','index'),title:``}
			],
     buttons7:[
				{type:'button',url:App.renderUrl('empty','index'),title:``}
			],
     buttons9:[
				{type:'button',url:App.renderUrl('set_timing','index'),title:``}
			]
},
