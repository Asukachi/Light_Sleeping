...
Page({
data: {
          swicthclz2:'weui-switch-checked',
switchchecked2:true,
     swicthclz3:'weui-switch-checked',
switchchecked3:true,
     buttons5:[
				{type:'button',url:App.renderUrl('setclock_page','index'),title:``}
			]
},
...
changetime_example01: function (e) {
	var checked = !e.currentTarget.dataset.checked;
    this.setData({
      swicthclz2: checked ?"weui-switch-checked":"",
      switchchecked2: checked
    }); 
},
changetime_example02: function (e) {
	var checked = !e.currentTarget.dataset.checked;
    this.setData({
      swicthclz3: checked ?"weui-switch-checked":"",
      switchchecked3: checked
    }); 
}
