...
data: {
          buttons3:[
				{type:'button',url:App.renderUrl('rank','index'),title:``}
			],
     buttons5:[
				{type:'button',url:App.renderUrl('Bind_home_users','index'),title:``}
			],
     buttons7:[
				{type:'button',url:App.renderUrl('forum_luntan','index'),title:``}
			]
},
