...
data: {
          buttons3:[
				{type:'button',url:App.renderUrl('Ways_to_improve_sleep_quality','index'),title:``}
			],
     buttons5:[
				{type:'button',url:App.renderUrl('Analysis_of_sleep_process','index'),title:``}
			],
     buttons7:[
				{type:'button',url:App.renderUrl('Bad_sleep_habits','index'),title:``}
			],
     buttons9:[
				{type:'button',url:App.renderUrl('What_is_sleep_disorder','index'),title:``}
			],
     buttons11:[
				{type:'button',url:App.renderUrl('World_sleep_day','index'),title:``}
			],
     buttons13:[
				{type:'button',url:App.renderUrl('Why_snore','index'),title:``}
			]
},
